...
import { LayoutTemplate, Sparkles, Cpu, Settings, Activity, Upload, Link } from 'lucide-react';
...
import ModelFactorySettingsView from './ModelFactorySettingsView';
import OperationCenterView from './OperationCenterView';
import ObservabilityView from './ObservabilityView';
import ReleaseCanaryView from './ReleaseCanaryView';
import IntegrationCenterView from './IntegrationCenterView';
...
type SubView = 'library' | 'designer' | 'settings' | 'operation' | 'observability' | 'release_canary' | 'integrations';
        ...
        <div className="h-full flex flex-col bg-slate-50">
            ...
            <div className="bg-white border-b border-slate-200 px-6 py-4">
                <div className="flex items-center justify-between">
                    ...
                    {/* Tab Navigation */}
                    <div className="flex items-center bg-slate-100 rounded-lg p-1 overflow-x-auto max-w-4xl no-scrollbar">
                        <button
                            onClick={() => setActiveSubView('library')}
                            className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center space-x-2 whitespace-nowrap ${activeSubView === 'library'
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center space-x-2 whitespace-nowrap ${activeSubView === 'designer'
                                ? 'bg-white text-slate-900 shadow-sm'
                                : 'text-slate-600 hover:text-slate-900'
                                }`}
                        >
                        ...
                        <button
                            onClick={() => setActiveSubView('release_canary')}
                            className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center space-x-2 whitespace-nowrap ${activeSubView === 'release_canary'
                                ? 'bg-white text-slate-900 shadow-sm'
                                : 'text-slate-600 hover:text-slate-900'
                                }`}
                        >
                        ...
                        <button
                            onClick={() => setActiveSubView('operation')}
                            className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center space-x-2 whitespace-nowrap ${activeSubView === 'operation'
                                ? 'bg-white text-slate-900 shadow-sm'
                                : 'text-slate-600 hover:text-slate-900'
                                }`}
                        >
                        ...
                        <button
                            onClick={() => setActiveSubView('observability')}
                            className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center space-x-2 whitespace-nowrap ${activeSubView === 'observability'
                                ? 'bg-white text-slate-900 shadow-sm'
                                : 'text-slate-600 hover:text-slate-900'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center space-x-2 whitespace-nowrap ${activeSubView === 'integrations'
                                ? 'bg-white text-slate-900 shadow-sm'
                                : 'text-slate-600 hover:text-slate-900'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center space-x-2 whitespace-nowrap ${activeSubView === 'settings'
                                ? 'bg-white text-slate-900 shadow-sm'
                                : 'text-slate-600 hover:text-slate-900'
                                }`}
                        >
